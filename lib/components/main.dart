        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                child: customCard(
                    "Trending", "450 Spots", Icons.access_alarm, "1")),
          ],
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
            ...
            Column(
              children: <Widget>[
                Container(
                    ...
                    child: customCard(
                        "Hotels", "257 Spots", Icons.accessibility, "2")),
                Container(
                  height: ((MediaQuery.of(context).size.height) -
                          appBarHeight -
                          navBarHeight -
            ...
            Column(
              children: <Widget>[
                Container(
                    ...
                    width: MediaQuery.of(context).size.width * .5,
                    child: customCard(
                        "Popularity", "117 Spots", Icons.attach_money, "4")),
                Container(
                    height: ((MediaQuery.of(context).size.height) -
                            appBarHeight -
                            navBarHeight -
                    ...
                    width: MediaQuery.of(context).size.width * .5,
                    child: customCard(
                        "Restaurants", "147 Spots", Icons.brightness_5, "5")),
              ],
            ),
          ],
        ),
